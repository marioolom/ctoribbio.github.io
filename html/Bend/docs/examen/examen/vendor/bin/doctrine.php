 ...
 *
 * This file includes the referenced bin path (../doctrine/orm/bin/doctrine.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../doctrine/orm/bin/doctrine.php';
